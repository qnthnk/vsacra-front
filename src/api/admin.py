...
from .models import db, User_principal, User, General_data, Clinical_data, Contact_data, Additional_data, Family, Family_additional_data, Family_clinical_data, Family_contact_data, Family_general_data, Family_social_media, Administrator
